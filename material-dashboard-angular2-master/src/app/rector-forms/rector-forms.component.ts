...
@Component({
  selector: 'app-rector-forms',
  templateUrl: './rector-forms.component.html',
  styleUrls: ['./rector-forms.component.css']
})
export class RectorFormsComponent implements OnInit {
  ...
  crearFormularioInscripcion(): void {
    ...
    this.formularioInscripcionService.crearFormularioInscripcion(formularioInscripcion)
      .subscribe(res => {
        alert("(Rector) Estado actualizado exitosamente.");
